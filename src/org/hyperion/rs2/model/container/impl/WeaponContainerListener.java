...
public class WeaponContainerListener implements ContainerListener {
	...
	private void sendWeapon(int id, String name, String genericName) {
		if (name.equals("Unarmed")) {
			...
			player.getActionSender().sendInterfaceString(5857, name);
			...
			player.getActionSender().sendInterfaceString(12293, name);
			...
			player.getActionSender().sendInterfaceString(779, name);
			...
			player.getActionSender().sendInterfaceString(1767, name);
			...
			player.getActionSender().sendInterfaceString(331, name);
			...
			player.getActionSender().sendInterfaceString(4449, name);
			...
			player.getActionSender().sendInterfaceString(2279, name);
			...
			player.getActionSender().sendInterfaceString(5573, name);
			...
			player.getActionSender().sendInterfaceString(1701, name);
		} else if (genericName.startsWith("Axe")
				|| genericName.startsWith("Battleaxe")) {
			player.getActionSender().sendSidebarInterface(0, 1698);
			player.getActionSender().sendInterfaceModel(1699, 200, id);
			...
			player.getActionSender().sendInterfaceString(8463, name);
		} else {
			player.getActionSender().sendSidebarInterface(0, 2423);
			player.getActionSender().sendInterfaceModel(2424, 200, id);
			player.getActionSender().sendInterfaceString(2426, name);
		}
	}
